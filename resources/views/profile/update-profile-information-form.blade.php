<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Update your account\'s profile informations.') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="phone" type="number" class="mt-1 block w-full" wire:model.defer="state.phone" autocomplete="phone" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="apartment" value="{{ __('Apartment/Suite') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="town" value="{{ __('Town/City') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="postCode" value="{{ __('Post/Zip Code') }}" />
